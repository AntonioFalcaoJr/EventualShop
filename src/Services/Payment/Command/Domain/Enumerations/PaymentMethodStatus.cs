...
public class PaymentMethodStatus : SmartEnum<PaymentMethodStatus>
{
    ...
    public class CancellationDeniedMethodStatus : PaymentMethodStatus
    {
        public CancellationDeniedMethodStatus() : base(nameof(CancellationDenied), 3) { }
    }
    
    public class DeniedMethodStatus : PaymentMethodStatus
    {
    ...
    public class RefundDeniedMethodtatus : PaymentMethodStatus
    {

    ...
    where TProjection : IProjection
{
    ...
    Task UpdateFieldAsync<TField, TId>(TId id, string version, Expression<Func<TProjection, TField>> field, TField value, CancellationToken cancellationToken) where TId : struct;
}
...
public class EmailGateway : INotificationOptionGateway<Email>
{
    ...
    public Task<NotificationMethodStatus> CancelAsync(Email email, CancellationToken cancellationToken)
        => SendAsync(client => client.SendMailAsync(_options.Username, email.Address, email.Subject, email.Body, cancellationToken));

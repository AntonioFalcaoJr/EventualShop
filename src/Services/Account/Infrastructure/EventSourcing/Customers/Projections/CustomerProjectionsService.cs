...
namespace Infrastructure.EventSourcing.Customers.Projections
{
    public class CustomerProjectionsService : ICustomerProjectionsService
    {
        ...
        public Task<IPagedResult<CustomerDetailsProjection>> GetCustomersDetailsWithPaginationAsync(Paging paging, Expression<Func<CustomerDetailsProjection, bool>> predicate, CancellationToken cancellationToken)

...
namespace Application.EventSourcing.Customers.Projections
{
    ...
    {
        Task<IPagedResult<CustomerDetailsProjection>> GetCustomersDetailsWithPaginationAsync(Paging paging, Expression<Func<CustomerDetailsProjection, bool>> predicate, CancellationToken cancellationToken);

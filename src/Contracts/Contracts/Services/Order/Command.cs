...
{
    public record PlaceOrder(Dto.Customer Customer, IEnumerable<Dto.CartItem> Items, decimal Total, IEnumerable<Dto.PaymentMethod> PaymentMethods) : Message(CorrelationId: Customer.Id), ICommand;

...
{
    public record RequestPayment(Guid OrderId, decimal AmountDue, Dto.Address BillingAddress, IEnumerable<Dto.IPaymentMethod> PaymentMethods) : Message(CorrelationId: OrderId), ICommand;

...
{
    public record CreateAccount(Guid AccountId, string Email, string Password, string PasswordConfirmation, bool AcceptedPolicies, bool WishToReceiveNews) : Message(CorrelationId: AccountId), ICommand;

...
{
    public record PaymentRequested(Guid PaymentId, Guid OrderId, Dto.Money Amount, Dto.Address BillingAddress, string Status) : Message, IEvent;
    ...
    public record CreditCardAdded(Guid CartId, Guid MethodId, Dto.Money Amount, Dto.CreditCard CreditCard, string Status) : Message, IEvent;

    public record DebitCardAdded(Guid CartId, Guid MethodId, Dto.Money Amount, Dto.DebitCard DebitCard, string Status) : Message, IEvent;

    public record PayPalAdded(Guid CartId, Guid MethodId, Dto.Money Amount, Dto.PayPal PayPal, string Status) : Message, IEvent;
}
...
{
    public record PaymentDetails(Guid Id, Guid OrderId, string Amount, string Status, bool IsDeleted) : IProjection
    {
    ...
    public record PaymentMethodDetails(Guid Id, Guid OrderId, string Amount, Dto.IPaymentOption Option, string Status, bool IsDeleted) : IProjection
    {
    ...
    public record PaymentMethodListItem(Guid Id, Guid OrderId, string Amount, string Option, string Status, bool IsDeleted) : IProjection
    {

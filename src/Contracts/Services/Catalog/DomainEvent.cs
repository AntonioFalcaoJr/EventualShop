...
public static class DomainEvent
{
    ...
    public record CatalogItemAdded(Guid CatalogId, Guid ItemId, Guid InventoryId, Dto.Product Product, decimal UnitPrice, string Sku, int Quantity) : Message, IEvent;

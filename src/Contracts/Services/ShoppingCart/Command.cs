...
public static class Command
{
    ...
    public record AddCreditCard(Guid CartId, decimal Amount, Dto.CreditCard CreditCard) : Message, ICommand;

    public record AddDebitCard(Guid CartId, decimal Amount, Dto.DebitCard DebitCard) : Message, ICommand;

    public record AddPayPal(Guid CartId, decimal Amount, Dto.PayPal PayPal) : Message, ICommand;

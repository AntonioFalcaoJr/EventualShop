...
public record ProductViewModel
{
    ...
    public static implicit operator Dto.Product(ProductViewModel productViewModel)
        => new(productViewModel.Description, productViewModel.Name, productViewModel.PictureUrl, productViewModel.Brand, productViewModel.Category, productViewModel.Unit);

...
namespace Infrastructure.Abstractions.EventSourcing.Projections
{
    public abstract class ProjectionsRepository : IProjectionsRepository
    {
        ...
        public virtual Task<IPagedResult<TProjection>> GetAllAsync<TProjection>(IPaging paging, Expression<Func<TProjection, bool>> predicate, CancellationToken cancellationToken) where TProjection : IProjection
        {

...
| Account                                                                                                                                                                                                                                                                         | Catalog                                                                                                                                                                                                                                                                         | Identity                                                                                                                                                                                                                                                                           | Order                                                                                                                                                                                                                                                                     | Payment                                                                                                                                                                                                                                                                         | ShoppingCart                                                                                                                                                                                                                                                                                    | Warehouse                                                                                                                                                                                                                                                                             |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [![Account build and test](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/account-build-and-test.yaml/badge.svg)](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/account-build-and-test.yaml) | [![Catalog build and test](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/catalog-build-and-test.yaml/badge.svg)](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/catalog-build-and-test.yaml) | [![Identity build and test](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/identity-build-and-test.yaml/badge.svg)](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/identity-build-and-test.yaml) | [![Order build and test](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/order-build-and-test.yaml/badge.svg)](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/order-build-and-test.yaml) | [![Payment build and test](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/payment-build-and-test.yaml/badge.svg)](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/payment-build-and-test.yaml) | [![Shopping Cart build and test](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/shoppingcart-build-and-test.yaml/badge.svg)](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/shoppingcart-build-and-test.yaml) | [![Warehouse build and test](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/warehouse-build-and-test.yaml/badge.svg)](https://github.com/AntonioFalcao/EDA.CleanArch.DDD.CQRS.EventSourcing/actions/workflows/warehouse-build-and-test.yaml) |
